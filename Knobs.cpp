...
byte NOTE_PRESETS_MELODIC[NOTE_PRESETS_MELODIC_LENGTH][NOTE_PRESETS_ELEMENT_LENGTH] = {
	...
	{8, 68, 71, 73, 75, 77}*/
#else
  {0, 60, 63, 65, 67, 68, 69, 71, 72},
  {0, 60, 64, 65, 67, 69, 70, 72, 73},
  {0, 60, 65, 67, 68, 71, 72, 74, 75},
...
byte NOTE_PRESETS_DRUMS[NOTE_PRESETS_DRUMS_LENGTH][NOTE_PRESETS_ELEMENT_LENGTH] = {
	...
	{30, 53, 58, 76, 77, 54}
#else
  {30, 57, 40, 48, 44, 53, 58, 80, 41},
  {30, 49, 39, 60, 61, 53, 58, 80, 43},
  {30, 52, 39, 67, 68, 53, 58, 80, 43},
  {30, 53, 58, 76, 77, 67, 68, 80, 54}
#endif  
};
